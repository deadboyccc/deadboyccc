...
Backend engineer specializing in Java/Kotlin microservices, distributed systems, and AWS.
...
| | |
|:---|:---|
| 🏛️ **Core** | Java · Kotlin · Spring Boot · Spring Cloud · Spring Security · Spring Data |
| ☁️ **Infra** | AWS (EKS, Fargate, Lambda) · Kubernetes · Docker · Terraform |
| 🧠 **Approach** | TDD · Clean Architecture · DDD · JVM performance tuning |
